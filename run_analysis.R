...
#
# Coursera Getting and Cleaning Data Course Project by Raul Goycoolea
#
...
names(S) <- "subject"
limpio <- cbind(S, Y, X)
write.table(limpio, "merged_clean_data.txt")

# Creates tidy data set and put data in to file data_set_final.txt
...
write.table(result, "data_set_final.txt")
